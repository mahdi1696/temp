...
import {
  action_tradeInfo_syncAllFundsLastTradeInfo,
  action_tradeInfo_syncFundsLastTradeInfoByTsetmcId,
    ...
    <div className="grid grid-rows-[auto_minmax(0,_1fr)] gap-1">
      <div className="flex flex-col justify-self-start">
        <div className="flex gap-1">
          <Button
            onClick={() => {
              getData(action_tradeInfo_syncAllFundsLastTradeInfo.bind(null));
            }}
          >
            به روز رسانی
          </Button>
          <Button
            onClick={() => {
              ...
              if (failure) {
                getData(
                  action_tradeInfo_syncFundsLastTradeInfoByTsetmcId.bind(
                    null,
                    failure
                  )
                );
